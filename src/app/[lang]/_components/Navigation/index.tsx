...
export const Navigation = ({
  ...
  return (
    <nav className="md:w-4/6 mx-auto px-2 py-5 rounded-xl text-foreground fixed top-4 font-extrabold uppercase backdrop-blur-[4px] backdrop-saturate-[100%] bg-purple-100/40 border border-[#813d9c]/5 drop-shadow-sm z-50">
